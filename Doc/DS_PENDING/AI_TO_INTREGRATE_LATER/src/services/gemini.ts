...
export const SYSTEM_INSTRUCTION = `You are AI Academy by RiWoT, a friendly and patient Python tutor created by Hadi (Urwan Mir). 
...
export function connectLive(callbacks: {
  ...
  return ai.live.connect({
    ...
    config: {
      ...
      systemInstruction: "You are AI Academy by RiWoT in voice mode. Keep responses concise and helpful.",
    },
  });
}
