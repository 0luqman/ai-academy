...
function replaceInFile(filePath) {
    if (filePath.includes('branding-repair-v2.js')) return;
    try {
        ...
        // 2. PyGuide / PyGuide AI -> AI Academy by RiWoT
        content = content.replace(/PyGuide\s+AI/g, 'AI Academy by RiWoT');
        content = content.replace(/PyGuide/g, 'AI Academy by RiWoT');

        // 3. AI Academy -> AI Academy by RiWoT (to ensure consistency, avoiding double suffix)
        // Match "AI Academy" only if not followed by " by RiWoT"
...
console.log('Starting branding replacement: "Codecademy", "PyGuide" -> "AI Academy by RiWoT"');
walkDir(ROOT_DIR);
