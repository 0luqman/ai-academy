---
lessonId: mlengineeringdspythonfunctionsproject
courseId: ml-engineering
chapterId: chapter-2
lessonSlug: mlengineeringdspythonfunctionsproject
lessonTitle: ds-python-functions-project
order: 7
...
sourceFiles:
  - ML/#24 ds-python-functions-project.mhtml
practiceExercises: []
quiz: []
---
...
Nice job – you’ve created a simple Python function that we’ll use to estimate 
...
<Playground initialCode="# Try your Python code here!\n\nprint('Hello from mlengineeringdspythonfunctionsproject')" />
