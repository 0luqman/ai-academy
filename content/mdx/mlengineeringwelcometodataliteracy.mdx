---
lessonId: mlengineeringwelcometodataliteracy
courseId: ml-engineering
chapterId: chapter-1
lessonSlug: mlengineeringwelcometodataliteracy
lessonTitle: welcome-to-data-literacy
order: 2
...
sourceFiles:
  - ML/#2 welcome-to-data-literacy.mhtml
practiceExercises: []
quiz: []
---
...
<Playground initialCode="# Try your Python code here!\n\nprint('Hello from mlengineeringwelcometodataliteracy')" />
