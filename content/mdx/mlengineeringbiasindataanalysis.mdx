---
lessonId: mlengineeringbiasindataanalysis
courseId: ml-engineering
chapterId: chapter-1
lessonSlug: mlengineeringbiasindataanalysis
lessonTitle: bias-in-data-analysis
order: 16
...
sourceFiles:
  - ML/#15 bias-in-data-analysis.mhtml
practiceExercises: []
quiz: []
---
Would you follow your GPS anywhere? Even into a lake? That may sound ridiculous, but a quick [google search](https://www.google.com/search?q=cases+where+drivers+drove+into+lakes+and+rivers+because+their+GPS+instructed+them+to&rlz=1C5CHFA_enUS742US742&oq=cases+where+drivers+drove+into+lakes+and+rivers+because+their+GPS+instructed+them+to&aqs=chrome..69i57.233j0j7&sourceid=chrome&ie=UTF-8) brings up dozens of cases where drivers drove into lakes and rivers because their GPS instructed them to. Following GPS instructions against your better judgment is one example of automation bias. 
...
Computers, data, and [algorithms](https://ai-academy.riwot.com) are not actually completely objective. It is true that data analysis can help us make better decisions, but it is not immune to bias. Humans create technologies and algorithms. As a result, they often have human biases encoded into them. It’s clear that we need to pay attention to other information streams (our eyes and ears) when we drive with GPS. Similarly, we need to look at more information sources when we evaluate data analysis results or reports.
...
Data for this plot came from [Buolamwini et al. 2018, Proceedings of Machine Learning Research](http://proceedings.mlr.press/v81/buolamwini18a/buolamwini18a.pdf).
...
<Playground initialCode="# Try your Python code here!\n\nprint('Hello from mlengineeringbiasindataanalysis')" />
