---
lessonId: mlengineeringlast-hint-reviewii
courseId: ml-engineering
chapterId: chapter-2
lessonSlug: mlengineeringlast-hint-reviewii
lessonTitle: Last Hint... review-ii
order: 20
...
sourceFiles:
  - ML/#32.1 Last Hint... review-ii.mhtml
practiceExercises: []
quiz: []
---
...
# Using sortlist.sort()# Using sortedlist = sorted(list)


<Playground initialCode="# Try your Python code here!\n\nprint('Hello from mlengineeringlast-hint-reviewii')" />
