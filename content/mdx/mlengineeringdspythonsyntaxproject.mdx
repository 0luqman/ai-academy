---
lessonId: mlengineeringdspythonsyntaxproject
courseId: ml-engineering
chapterId: chapter-2
lessonSlug: mlengineeringdspythonsyntaxproject
lessonTitle: ds-python-syntax-project
order: 1
...
sourceFiles:
  - ML/#20 ds-python-syntax-project.mhtml
practiceExercises: []
quiz: []
---
...
- We are using this [medical insurance dataset](https://www.kaggle.com/mirichoi0218/insurance) as a guide, which unfortunately does not include data for non-binary individuals.
...
<Playground initialCode="# Try your Python code here!\n\nprint('Hello from mlengineeringdspythonsyntaxproject')" />
