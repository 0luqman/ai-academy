---
lessonId: dscpgroupprojectusmedicalinsurancecosts
courseId: ml-engineering
chapterId: chapter-5
lessonSlug: dscpgroupprojectusmedicalinsurancecosts
...
Select what you would like to work on together. We suggest [U.S. Medical Insurance Costs](/learn), which will help you to collaborate on a Python project using real-world data. Alternatively, come up with your own project that uses Python.
...
Find collaborators! [Visit the projects forum](https://discuss.discord.gg/qMd7jwV7UG). You can also find collaborators in the [data-science channel in our Discord server](https://discord.gg/QBn5MxG). If still looking for others to work with, check out the AI Academy by RiWoT [Facebook group](https://www.facebook.com/groups/discord.gg/qMd7jwV7UGmunity/), in a [AI Academy by RiWoT Chapter](https://discord.gg/qMd7jwV7UG), or at local meetups.
...
Step Five – Share!
If you completed the [U.S. Medical Insurance Costs](/learn) Project, share it with fellow learners on its [forum page](https://discuss.discord.gg/qMd7jwV7UG). If you choose to do another project, post your project in [the Projects category](https://discuss.discord.gg/qMd7jwV7UG) and share it with the other learners in the forums or on Discord! Getting feedback is a vital part of the development process and in growing your skills. Remember to give back to other people wanting feedback or guidance, not just because it’s a good thing to do, but you’ll also benefit by explaining to others what you’ve learned.
