---
lessonId: mlengineeringfridakahloretrospectiveproject
courseId: ml-engineering
chapterId: chapter-3
lessonSlug: mlengineeringfridakahloretrospectiveproject
lessonTitle: frida-kahlo-retrospective-project
order: 1
...
sourceFiles:
  - ML/#45 frida-kahlo-retrospective-project.mhtml
practiceExercises: []
quiz: []
---
Overview
...
We’re finally ready to create our master list. 
...
<Playground initialCode="# Try your Python code here!\n\nprint('Hello from mlengineeringfridakahloretrospectiveproject')" />
