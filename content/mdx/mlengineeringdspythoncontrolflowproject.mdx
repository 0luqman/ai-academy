---
lessonId: mlengineeringdspythoncontrolflowproject
courseId: ml-engineering
chapterId: chapter-2
lessonSlug: mlengineeringdspythoncontrolflowproject
lessonTitle: ds-python-controlflow-project
order: 13
...
sourceFiles:
  - ML/#27 ds-python-controlflow-project.mhtml
practiceExercises: []
quiz: []
---
...
insurance_cost=400∗age−128∗sex+425∗num_of_children+10000∗smoker−2500\begin{aligned}
...
<Playground initialCode="# Try your Python code here!\n\nprint('Hello from mlengineeringdspythoncontrolflowproject')" />
