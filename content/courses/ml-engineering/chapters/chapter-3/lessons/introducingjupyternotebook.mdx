---
lessonId: introducingjupyternotebook
courseId: ml-engineering
chapterId: chapter-3
lessonSlug: introducingjupyternotebook
...
Jupyter Notebook is a type of [Integrated Development Environment (IDE)](/learn). IDEs are places to write code that offer some supportive features. Almost all IDEs provide syntax highlighting, debugging, and code completion. Jupyter Notebook also offers embedded help documentation and introspection (i.e., you can check each command’s parameters) and in-line display of charts and images.
...
However, the best way to get familiar with Jupyter Notebook is to [work with it yourself](/learn). So without further ado, let’s walk through getting Jupyter Notebook and related tools installed on your computer in the [next article](/learn)!
