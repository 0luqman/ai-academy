---
lessonId: introtodataacquisition
courseId: ml-engineering
chapterId: chapter-4
lessonSlug: introtodataacquisition
...
Conducting research and experiments is typically out of the scope for Data Scientists, but surveys and simulations are common methods for acquiring primary data. Webscraping is also a special case of primary data collection by extracting or copying data directly from a website. To learn more, check out our [full course on webscraping](/learn) and this [article demonstrating how to webscrape MLB stats using Python](/learn).
